...
```{r b-standardized-estimates}
summary(b1)
```

### Natural scale

```{r b-natural-scale-estimates}
...
```{r b-plot-intervals-of-major-categories, message=FALSE, fig.height=2.8}
...
```{r b-warnings-vs-no-warnings, message=FALSE, fig.height=2.8}
