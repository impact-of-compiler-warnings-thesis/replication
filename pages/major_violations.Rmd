...
```{r mav-determine-natural-scale-means, message=FALSE}
summary(mav5)

mav5_std_means <- c(-0.04, 0.05, -0.08, -0.05, 0.49, -0.07, -0.17, -0.03, -0.22, -0.16, -0.05)
determine_natural_scale_means(mav5_std_means, df$major_violations_kloc)
```
...
```{r mav-determine-natural-scale-means-culled, message=FALSE}
summary(mav5_culled)

mav5_culled_std_means <- c(0.20, 0.45, -0.04, 0.12, -0.10, 0.00, -0.37, -0.05, -0.55, -0.28, -0.03)
determine_natural_scale_means(mav5_culled_std_means, culled_df$major_violations_kloc)
```
