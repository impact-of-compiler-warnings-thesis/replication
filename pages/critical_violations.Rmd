...
```{r cv-determine-natural-scale-means}
summary(cv1)

cv1_std_means <- c(0.46, 0.15, 0.04, -0.29, -0.06, -0.31, -0.34, -0.22, 0.01, -0.43, -0.49)
determine_natural_scale_means(cv1_std_means, df$critical_violations_kloc)
```
