...
plot_intervals_of_major_categories(td1) + labs(title="TD2", x="Technical Debt Ratio (std)")
```

## Warnings versus no warnings
```{r td-warnings-no-warnings , fig.width=6, fig.height=2.8}
td2_factor_uses_warnings <- fit_model_td1("td1_factor_uses_warnings", data_factor_uses_warnings)
