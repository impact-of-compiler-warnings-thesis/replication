...
```{r b-determine-natural-scale-means}
summary(b1)

b1_std_means <- c(0.27, 0.24, -0.02, 0.37, -0.28, -0.20, -0.23, 0.47, -0.02, -0.29, -0.10)
determine_natural_scale_means(b1_std_means, df$bugs_kloc)
```
