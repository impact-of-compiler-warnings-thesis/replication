...
```{r cyc-determine-natural-scale-values}
summary(cyc7)
...
summary(cyc7_culled)
print(create_natural_scale_summary_df(cyc7_culled, df_culled$cyclomatic_complexity_kloc))
```
...
data_cyc_factor_uses_warnings <- create_cyclomatic_complexity_data(df_culled)
data_cyc_factor_uses_warnings$category <- factor(uses_warnings(df_culled$category))
