...
```{r cog-determine-natural-scale-means}
summary(cog5)

cog5_std_means <- c(-0.22, 0.44, 0.33, -0.40, 0.47, -0.25, -0.50, -0.69, -0.04, 0.42, -0.67)
determine_natural_scale_means(cog5_std_means, df$cognitive_complexity_kloc)
```
