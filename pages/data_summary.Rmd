...
ggplot(df_locdata,
  ...
  geom_hline(yintercept=1:5 * 40000, alpha=0.2) +
  scale_y_continuous(breaks=1:5 * 40000)
...
### Technical Debt
```{r ds-technical-debt-summary}
plot_barplot_of_major_samples(df_major, df_major$sqale_debt_ratio) +
  labs(title="Overview of all major samples", x="Samples", y="Tech Debt Ratio") +
