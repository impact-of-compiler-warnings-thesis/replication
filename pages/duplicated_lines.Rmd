...
```{r d-compare-models, message=FALSE}
...
```{r d-determine-natural-scale-means}
summary(d6)

d6_std_means <- c(0.18, -0.26, -0.11, -0.32, 0.15, 1.12, -0.30, 0.02, -0.23, -0.24, -0.29)
determine_natural_scale_means(d6_std_means, df$duplicated_lines_kloc)
```

## Credible intervals of major categories

```{r d-plot-intervals-of-major-categories, fig.width=6, fig.height=2.8, message=FALSE}
...
# Fit D6 using data that uses binary factor for usage of warnings
