...
```{r s-determine-natural-scale-means}
s2_std_means <- c(0.26, 0.19, -0.20, -0.45, -0.10, -0.17,  0.01,  0.67, -0.39, -0.16, -0.19)
determine_natural_scale_means(s2_std_means, df$security_hotspots_kloc)
```
...
# Fit S2 using data that uses binary factor for usage of warnings
