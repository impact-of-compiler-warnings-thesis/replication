...
cs1 <- add_criterion(cs1, criterion="loo")
...
cs2 <- add_criterion(cs2, criterion="loo")
...
cs3 <- add_criterion(cs3, criterion="loo")
...
cs4 <- add_criterion(cs4, criterion="loo")
...
cs5 <- add_criterion(cs5, criterion="loo")
...
cs6 <- add_criterion(cs6, criterion="loo")
...
cs7 <- add_criterion(cs7, criterion="loo", moment_matching=TRUE)
