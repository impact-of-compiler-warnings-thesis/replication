...
```{r miv-determine-natural-scale-means, message=FALSE}
summary(miv1)

miv1_std_means <- c(0.27, 0.22, -0.15, 0.46, -0.15, -0.28, -0.23, 0.42, 0.32, -0.21, 0.20)
determine_natural_scale_means(miv1_std_means, df$minor_violations_kloc)
```
